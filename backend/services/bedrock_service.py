...
def get_ai_recommendation(
  ...
  travel_month: str
	...
	prompt = (
		f"As an experienced travel planner, arrange {days}-day itinerary for {destination}. With budget {currency} {budget}, travel style {travel_style}, and planned arrival on {travel_month}, arrange itineraries in daily basis activities, include: daily budget estimation, local culinaries, cultural or historical sites, night life, and transport. Give response in indonesian language. Format your answer in proper markdown with headers and bulleted lists as needed."
	)
